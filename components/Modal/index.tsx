...
const buildLinkText = (link?: string): string => {
  ...
  } else if (link?.toLowerCase().search(/\S*amazon\S*/) !== -1) {
    return 'Amazon Website';
  } else if (link?.toLowerCase().search(/\S*digikey\S*/) !== -1) {
    return 'Digi-Key Website';
      ...
      show && (
        ...
        >
          <button
            ...
            className={`${styles.close} ${show && styles.animateEnterTranslateUp
              }`}
          >
            Close
            <img
          ...
          <div
            className={`${styles.card} ${show && styles.animateEnterTranslateUp
              }`}
          >
